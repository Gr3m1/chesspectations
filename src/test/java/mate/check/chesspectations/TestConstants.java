...
public abstract class TestConstants {
    ...
    public static List<PlayerDetail> getPlayerDetails() {
        PlayerDetail player1 = new PlayerDetail();
        player1.setId("123");
        ...
        PlayerDetail player2 = new PlayerDetail();
        player2.setId("456");
        ...
        PlayerDetail player3 = new PlayerDetail();
        player3.setId("789");
