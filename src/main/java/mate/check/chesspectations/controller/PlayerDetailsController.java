...
public class PlayerDetailsController {
    ...
    // get all players
    @GetMapping
    public ResponseEntity<List<PlayerDetail>> getAllPlayers() {
    ...
    public ResponseEntity<PlayerRank> getPlayerByName(@PathVariable ("name") String name) {
    ...
    public ResponseEntity<PlayerRank> getPlayerByEmail(@PathVariable ("email") String email) {
    ...
    public ResponseEntity<PlayerRank> addNewPlayer(@RequestBody @Valid PlayerDetail playerDetail) {
    ...
    @PutMapping("/update")
    public ResponseEntity<PlayerDetail> updatePlayerDetail(@RequestBody @Valid PlayerDetail playerDetail) {
    ...
    public ResponseEntity<Void> removePlayerByName(@PathVariable ("name") String name) {
    ...
    public ResponseEntity<Void> removePlayerByEmail(@PathVariable ("email") String email) {
